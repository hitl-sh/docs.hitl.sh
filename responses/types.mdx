...
<Card title="Editable Draft" icon="edit">
...
request_data = {
    ...
    "type": "markdown",
    "priority": "medium",
    "request_text": "Please review and edit this AI-generated client notification before it is sent.",
    ...
    "default_response": "Notification not reviewed within timeout period",
    "timeout_seconds": 3600,
    "platform": "api"
}
...
<Step title="Editable Text for Human Polish">
...
def handle_response(request_id, response_data, response_type):
    ...
    if response_type == "text":
        ...
        send_client_notification(revised_text)
        if was_edited:
            log_human_revision(request_id, revised_text)
```
