...
<Frame>
<img src="/images/integrations/mobile-pics/get-started.png" alt="HITL mobile app get started screen" style={{maxWidth: '350px', margin: '0 auto'}} />
</Frame>
...
<Frame>
<img src="/images/integrations/mobile-pics/home-page-loop-requests.png" alt="HITL mobile app home screen with active requests and loops" style={{maxWidth: '350px', margin: '0 auto'}} />
</Frame>
...
<Frame>
<img src="/images/integrations/mobile-pics/loop-request-notification.png" alt="HITL mobile app push notification for new request" style={{maxWidth: '350px', margin: '0 auto'}} />
</Frame>
...
<Frame>
<img src="/images/integrations/mobile-pics/settings-2.png" alt="HITL mobile app settings screen for notification customization" style={{maxWidth: '350px', margin: '0 auto'}} />
</Frame>
...
Ready to start reviewing? Here's how to get started with the HITL mobile app:

<CardGroup cols={2}>
<Card title="Download the App" icon="mobile" href="https://my.hitl.sh">
Get the HITL mobile app for iOS and Android devices.
</Card>

<Card title="Join Your First Loop" icon="link" href="/mobile/join-loop">
Follow our step-by-step guide to join a review loop and start receiving requests.
</Card>

<Card title="Navigate the Home Screen" icon="home" href="/mobile/home-screen">
Learn how to use the app interface and manage your review workload.
</Card>

<Card title="Master Responding" icon="message-circle" href="/mobile/responding">
Discover how to provide effective responses across all response types.
</Card>
</CardGroup>
