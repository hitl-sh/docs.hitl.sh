...
const response = await axios.get('https://dev.api.hitl.sh/v1/loops', { headers });
```
...
func main() {
    req, _ := http.NewRequest("GET", "https://dev.api.hitl.sh/v1/loops", nil)
...
curl_setopt_array($curl, [
    CURLOPT_URL => "https://dev.api.hitl.sh/v1/loops",
