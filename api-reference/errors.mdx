...
```bash
# Test API key
curl -v -H "Authorization: Bearer your_api_key" https://dev.api.hitl.sh/v1/api/loops
```
</Accordion>
...
curl -I -H "Authorization: Bearer your_api_key" https://dev.api.hitl.sh/v1/api/loops
