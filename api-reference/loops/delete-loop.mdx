---
title: "Delete Loop"
api: "DELETE https://api.hitl.sh/v1/api/loops/{id}"
...
async function safeDeleteLoop(loopId, requireConfirmation = true) {
    try {
        // Get loop information first
        const loopResponse = await axios.get(`https://api.hitl.sh/v1/api/loops/${loopId}`, {
        ...
        try {
            const requestsResponse = await axios.get(`https://api.hitl.sh/v1/api/loops/${loopId}/requests`, {
                headers: { 'Authorization': `Bearer ${apiKey}` }
            });
        ...
        // Proceed with deletion
        const deleteResponse = await axios.delete(`https://api.hitl.sh/v1/api/loops/${loopId}`, {
            headers: { 'Authorization': `Bearer ${apiKey}` }
        });
...
async function archiveLoop(loopId) {
    // Get current loop data
    const response = await axios.get(`https://api.hitl.sh/v1/api/loops/${loopId}`, {
        headers: { 'Authorization': `Bearer ${apiKey}` }
    });
