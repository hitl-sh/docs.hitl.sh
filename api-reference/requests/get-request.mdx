---
title: "Get Request"
api: "GET https://dev.api.hitl.sh/v1/api/requests/{id}"
...
```bash cURL
curl -X GET https://dev.api.hitl.sh/v1/api/requests/65f1234567890abcdef12348 \
...
url = "https://dev.api.hitl.sh/v1/api/requests/65f1234567890abcdef12348"
headers = {
...
const response = await axios.get(
  'https://dev.api.hitl.sh/v1/api/requests/65f1234567890abcdef12348',
  {
    headers: {
      'Authorization': 'Bearer your_api_key_here'
    }
...
def poll_request_status(request_id, api_key, max_attempts=120):
    ...
    url = f"https://dev.api.hitl.sh/v1/api/requests/{request_id}"
