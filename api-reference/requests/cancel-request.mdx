...
api: "DELETE https://dev.api.hitl.sh/v1/api/requests/{id}"
description: "Cancel a pending request. Only requests that haven't been completed can be cancelled."
---
...
```bash cURL
curl -X DELETE https://dev.api.hitl.sh/v1/api/requests/65f1234567890abcdef12348 \
