...
api: "DELETE https://dev.api.hitl.sh/v1/requests/{id}"
...
```bash cURL
curl -X DELETE https://dev.api.hitl.sh/v1/requests/65f1234567890abcdef12348 \
...
def cancel_request(request_id, confirm=True):
    ...
    if confirm:
        ...
        get_response = requests.get(
            f"https://dev.api.hitl.sh/v1/requests/{request_id}",
