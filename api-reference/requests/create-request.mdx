...
api: "POST https://dev.api.hitl.sh/v1/loops/{loopId}/requests"
...
response = requests.post(
    f"https://dev.api.hitl.sh/v1/loops/{LOOP_ID}/requests",
...
const response = await axios.post(
  `https://dev.api.hitl.sh/v1/loops/${LOOP_ID}/requests`,
  {
    processing_type: 'time-sensitive',
    type: 'markdown',
    priority: 'medium',
