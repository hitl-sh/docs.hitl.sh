...
<Accordion title="✏️ Editable Draft" icon="pen">
...
<ParamField body="type" type="string" required>
  ...
  <br />
  <strong>Options:</strong> `markdown`, `image`, `file`, `video`, `audio`
</ParamField>
...
<ParamField body="file_names" type="string[]">
...
<ParamField body="response_type" type="string" required>
  ...
  <br />
  <strong>Options:</strong> `text`, `editable_text`, `single_select`, `multi_select`, `rating`, `number`
</ParamField>
...
<Accordion title="✏️ Editable Draft" icon="pen-to-square">
