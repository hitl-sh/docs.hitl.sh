...
const response = await fetch('https://dev.api.hitl.sh/v1/api/loops', {
  headers: {
...
```bash cURL
# Create a test loop
curl -X POST https://dev.api.hitl.sh/v1/api/loops \
  -H "Authorization: Bearer your_api_key_here" \
...
curl -X POST https://dev.api.hitl.sh/v1/api/requests \
  -H "Authorization: Bearer your_api_key_here" \
  -H "Content-Type: application/json" \
  -d '{
...
# Create test request
response = requests.post(
    "https://dev.api.hitl.sh/v1/api/requests",
    headers={
        "Authorization": "Bearer your_api_key_here",
        "Content-Type": "application/json"
    },
...
```javascript JavaScript
const response = await fetch('https://dev.api.hitl.sh/v1/api/requests', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your_api_key_here',
    'Content-Type': 'application/json'
...
class HITLIntegrationTest:
    def __init__(self, api_key):
        ...
        self.base_url = "https://dev.api.hitl.sh/v1"
...
HITL_API_BASE = "https://dev.api.hitl.sh/v1"  # Development server
...
HITL_API_BASE = "https://dev.api.hitl.sh/v1"  # Production server
...
def test_rate_limits(api_key):
    ...
    for i in range(105):  # Exceed 100/hour limit
        response = requests.get("https://dev.api.hitl.sh/v1/api/loops", headers=headers)
